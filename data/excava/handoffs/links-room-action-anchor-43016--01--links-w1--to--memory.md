# Hand-off — [links room action] Anchor delivers the prioritized report of broken/outdated links with recommendations to the links department for review.

| | |
|---|---|
| task | `links-room-action-anchor-43016` (step 1/8) |
| from | **links-w1** |
| to | **memory** department |
| at | 2026-07-29T14:57:35.536311+00:00 |
