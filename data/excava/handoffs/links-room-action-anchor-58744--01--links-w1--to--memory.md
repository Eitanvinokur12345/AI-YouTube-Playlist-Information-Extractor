# Hand-off — [links room action] Anchor delivers the prioritized report of broken/outdated links with status and location to the room for review.

| | |
|---|---|
| task | `links-room-action-anchor-58744` (step 1/8) |
| from | **links-w1** |
| to | **memory** department |
| at | 2026-07-30T17:53:45.066784+00:00 |
