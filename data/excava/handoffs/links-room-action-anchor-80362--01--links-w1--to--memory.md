# Hand-off — [links room action] Anchor delivers the prioritized report of broken/outdated links with deadlines and owners assigned.

| | |
|---|---|
| task | `links-room-action-anchor-80362` (step 1/8) |
| from | **links-w1** |
| to | **memory** department |
| at | 2026-07-29T15:55:06.516873+00:00 |
