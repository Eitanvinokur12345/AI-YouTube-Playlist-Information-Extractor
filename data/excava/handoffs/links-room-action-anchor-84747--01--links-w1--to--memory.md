# Hand-off — [links room action] Anchor compiles and shares the verified list of active links and the broken ones, with fixes prioritized, by end of day.

| | |
|---|---|
| task | `links-room-action-anchor-84747` (step 1/8) |
| from | **links-w1** |
| to | **memory** department |
| at | 2026-08-03T01:30:34.105730+00:00 |
