# Hand-off — [links room action] Anchor compiles and shares the verified list of active links and the broken/redirected ones needing updates or removals.

| | |
|---|---|
| task | `links-room-action-anchor-93361` (step 1/8) |
| from | **links-w1** |
| to | **memory** department |
| at | 2026-08-03T01:37:02.931510+00:00 |
