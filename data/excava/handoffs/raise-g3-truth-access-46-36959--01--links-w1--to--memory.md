# Hand-off — Raise G3 Truth & access (46/100): 46.4% of tools/skills have a real link (target: ~100%)

| | |
|---|---|
| task | `raise-g3-truth-access-46-36959` (step 1/8) |
| from | **links-w1** |
| to | **memory** department |
| at | 2026-09-18T13:09:23.129887+00:00 |

## What was done
Link-coverage pass assessed: **5402/10144 linked (53.25%)**, moving -0.12%/day against the +5.0%/day target (NOT on track — resolver budget is the lever). The resolver lane (batch+parallel+fast-engine) keeps running hourly in CI.
