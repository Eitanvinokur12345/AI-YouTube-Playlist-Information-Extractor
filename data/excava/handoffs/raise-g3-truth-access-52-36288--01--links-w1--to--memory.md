...
| at | 2026-08-02T07:08:54.198387+00:00 |

## What was done
Link-coverage pass assessed: **4706/7956 linked (59.15%)**, moving -0.05%/day against the +5.0%/day target (NOT on track — resolver budget is the lever). The resolver lane (batch+parallel+fast-engine) keeps running hourly in CI.
...
## What remains
3250 items still unlinked. After each resolver batch the semantic index must be re-embedded so EXCAVA's recall sees the NEW links, not last week's.
