...
REAL_TOOL = {"security": "src.security_scan", "improve": "src.self_check",
             ...
             "accessibility": "src.accessibility_scan"}  # 2026-07-25: WCAG-lite scan of EXCAVA's own UI shells
...
TOOL_DOMAIN = {
    ...
    "src.accessibility_scan": {"accessibility", "a11y", "contrast", "mobile", "touch",
                               "reduced-motion", "keyboard", "screen-reader", "aria", "wcag", "legibility"},
